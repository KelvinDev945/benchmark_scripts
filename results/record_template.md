...
| 云端 RTX 4090 48G（sc02，2026-08-01） | 132.3-139 TFLOPS（稳态约132-133 TFLOPS，对比"真实RTX 4090"165TFLOPS约80%；errors:0，峰值温度76°C；实际可用显存48101MB，压测占用43291MB） | 待测 | 待测 | 跟"云端 4090"（139.7 TFLOPS）算力几乎一致，符合预期——同芯片只是显存从24G加到48G，核心算力不受影响 |
| （新测的卡） | | | | |
